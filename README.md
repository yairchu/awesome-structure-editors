...
|--------:|:-----:|:------------|:----------:|:--:|:-------:
| [Enso](https://enso.org) | $ 📖 ⤴️ 👶 λ | Hybrid visual+textual programming language | [5506](https://github.com/enso-org/enso) | 2022
| [Unison](https://unisonweb.org) | $ 📖 👶 λ | Code database projected to text-files edited in your text editor of choice. Originally centered around having a projectional editor, but pivoted to creating a cloud programming language first | [4381](https://github.com/unisonweb/unison) | 2022
| [Lamdu](http://www.lamdu.org) | ⌨️ 👶 λ 文 | Language with live programming and novel UX for type errors | [1753](https://github.com/lamdu/lamdu) | 2022
| [MPS](https://www.jetbrains.com/mps/) | $ ⌨️ 🔨 | Language workbench for projectional languages | [1305](https://github.com/JetBrains/MPS) | 2022
| [Dark](https://darklang.com) | $ ⌨️ 👶 λ 🌐 | Platform and language as a service for app backends and web | [1036](https://github.com/darklang/dark) | 2022
| [Hazel](http://hazel.org) | 🎓 ⌨️ 👶 λ 🌐 | Language with live programming and typed holes | [466](https://github.com/hazelgrove/hazel) | 2022
| [Sapling](https://github.com/kneasle/sapling) | ⌨️ | Vim/Kakoune-inspired modal structured editor for existing languages | 354 | 2022
| [Fructure](https://fructure-editor.tumblr.com) | ｟ | ? | [344](https://github.com/disconcision/fructure) | 2020
| [Cirru](http://cirru.org) | ｟ | A tree editor for ClojureScript | [195](https://github.com/Cirru/calcit-editor) | 2022
| [ProjecturEd](https://github.com/projectured/projectured) | 👨‍👩‍👧‍👦 | General purpose projectional editor | 125 | 2021
| [Vlojure](https://vlojure.io) | ⤴️ ｟ 🌐 | A novel visual UX for ClojureScript | [112](https://github.com/Ella-Hoeppner/Vlojure) | 2022
| [Envision](http://dimitar-asenov.github.io/Envision/) | 🎓 👶 | Editor for a Java/C++ like language | [84](https://github.com/dimitar-asenov/Envision) | 2022
| [Tofu](https://github.com/Gregoor/tofu) | ☕ | VSCode extension for structured editing of JavaScript and TypeScript | 83 | 2022
| [Holbert](http://liamoc.net/holbert) | 🎓 🌐 | A graphical interactive proof assistant designed for education | [82](https://github.com/liamoc/holbert) | 2022
| [Subtext](http://www.subtext-lang.org) | 👶 | A serie of inspiring presentations and projects exploring ideas in projectional editing | [82](https://github.com/JonathanMEdwards/subtext10) | 2022
| [Foundry](https://github.com/int-index/foundry) | λ | A projectional editor for the Morte language | 28 | 2022
| [Lisperanto](https://github.com/uprun/lisperanto) | ｟ 🌐 | IDE for Lisp-like language | 24 | 2022
| [Forest](https://github.com/tehwalris/forest) | ☕ | A prototype tree editor for TypeScript | 20 | 2022
| [Frugel](https://github.com/cdfa/frugel) | 🎓 ⌨️ 👶 λ | A research exploring a novel UX for textual entry of code | 9 | 2022
